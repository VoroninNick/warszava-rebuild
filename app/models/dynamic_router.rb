      ...
      Page.all.each do |page|
        ...
        page.translations_by_locale.keys.each do |locale|
          I18n.with_locale locale do
            get "#{page.full_path}", :to => to, defaults: { page_id: page.id, locale: locale, locale_missed_in_request_url: true }
            get "(#{locale.to_s})#{page.full_path}", :to => to, defaults: { page_id: page.id, locale: locale }
          end
        end
